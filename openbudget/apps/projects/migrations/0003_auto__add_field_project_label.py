...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.label'
        db.add_column(u'projects_project', 'label',
                      self.gf('django.db.models.fields.CharField')(default='public', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Project.label'
        db.delete_column(u'projects_project', 'label')
    ...
    models = {
        ...
        u'projects.project': {
            ...
            'client_id': ('django.db.models.fields.CharField', [], {'default': 'u\'@Q .$Ywl?C#-/jip=cRM2KsHh""Nfliqrx2!izGK\'', 'unique': 'True', 'max_length': '100'}),
            'client_secret': ('django.db.models.fields.CharField', [], {'default': 'u\'GR}?*96q%fZ7m6eIp&xsn9Yx`\\\'*"Pk4PP!HXn%dzw2wNrG{@!2B<70>5[2ST<.Aoe\\\\_H1Pd@R\\\\8-?dVhwXDH@|Ct,!M>Rr_htz>?b4=r%qcN;l(BH]W}`d3r=4QJ:mRd\'', 'max_length': '255', 'blank': 'True'}),
